    ...
    if command_name == "analyze":
        ...
        monkeypatch.setattr(
            ...
            lambda *_args, **_kwargs: SimpleNamespace(
                ...
                borg=SimpleNamespace(state=cli_module.BorgState.READY_TO_EXECUTE),
                publication=SimpleNamespace(
                    files=(
                        SimpleNamespace(
                            path=paths.tracked_dir / "tasks" / "matrix.md"
                        ),
                    )
                ),
            ),
        ...
        expected_report = (
            ...
            "Borg 'matrix' is ready to execute.\n"
            "Current tasks:\n"
            "  .betterborg/tasks/matrix.md\n"
        )
